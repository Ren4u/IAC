...
# SOA Architecture specific variables 

variable "security_svc_cidr" {
  type = string 
}

variable "monitoring_svc_cidr" {
  type = string 
}

#  TGW identifier variable for attachements

variable "networktgwid" {
  type = string 
}
